...
| Field | Value |
|---|---|
| Repository | `typescript_nestjs_crud_project` |
...
Follows the scaffold idiomatico of TypeScript: code-fonte, tests and manifesto of build
...
- [ ] `npm run dev` executa the componente.
